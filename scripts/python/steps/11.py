...
for test_fold in test_folds:
    for n_train in n_trains:
        ...
        for region in RegionNames:
            ...
            pretrained_model = (f'segmenter-{region}', 'public-1gpu-150epochs', 'best')
            train_segmenter(seg_dataset, region, f'segmenter-{region}', 'int-1gpu-150epochs', n_epochs=n_epochs, n_folds=n_folds, n_train=n_train, pretrained_model=pretrained_model, test_fold=test_fold)
